...
const uni = [];
graduates.filter(obj => (obj.university.includes('Uni')) ? uni.push(obj.university) : null)
console.log(uni);
...
zooAnimals.filter(animal => (animal.population < 5) ? lowerPopulation.push(animal.animal_name) : null)
